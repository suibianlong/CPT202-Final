...
public class AdminTagController {
    ...
    @PostMapping
    public AdminTagResponse createTag(@RequestBody(required = false) AdminTagRequest request,
                                      HttpServletRequest httpServletRequest) {
        CurrentUserVO adminUser = resourcePermissionChecker.requireAdminUser(httpServletRequest);
        return classificationManagementService.createTag(request, administratorName(adminUser));
    }
