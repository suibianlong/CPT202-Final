...
public class AdminResourceController {
    ...
    public AdminResourceLifecycleResponse unpublishResource(@PathVariable Long resourceId, HttpServletRequest request) {
        resourcePermissionChecker.requireAdminUser(request);
        return lifecycleService.unpublishResource(resourceId);
    }
}
