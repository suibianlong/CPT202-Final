...
public class AdminResourceLifecycleServiceImpl implements AdminResourceLifecycleService {
    ...
    private static final String UNPUBLISH_NOT_SUPPORTED_MESSAGE =
            "Unpublish is not supported by the current schema because resource.status has no Unpublished value or separate publication flag.";
    ...
    @Override
    public AdminResourceLifecycleResponse unpublishResource(Long resourceId) {
        loadResource(resourceId);
        // TODO: Implement only if the main schema gains an explicit Unpublished state or publication flag.
        throw new AppException(501, UNPUBLISH_NOT_SUPPORTED_MESSAGE);
    }
