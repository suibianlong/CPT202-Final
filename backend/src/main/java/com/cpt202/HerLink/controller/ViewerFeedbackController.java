...
// Handle users‘ feedbacks submission and feedback lookup.
@RestController
...
public class ViewerFeedbackController {
    ...
    @GetMapping("/all")
    public List<FeedbackVO> listAllFeedback(HttpServletRequest request) {
        resourcePermissionChecker.requireAdminUserId(request);
        return viewerFeedbackService.listAllFeedback();
    }
}
