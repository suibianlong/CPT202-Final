...
public interface UserAccessService {
    ...
    ContributorRequestVO getContributorRequestDetail(Long requestId);

    List<ContributorRequestVO> listApprovedContributors();

    ContributorRequestVO reviewContributorRequest(Long adminUserId,
                                                  Long requestId,
                                                  ContributorReviewDecisionRequest request);

    ContributorRequestVO revokeContributor(Long adminUserId, Long contributorUserId, String administrator);
}
